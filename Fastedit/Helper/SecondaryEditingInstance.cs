...
{
    public class SecondaryEditingInstance
    {
        ...
        public SecondaryEditingInstance(MainPage mp, TabActions tabactions, muxc.TabView tabcontrol)
        {
            mainpage = mp;
            this.tabactions = tabactions;
            this.TextTabControl = tabcontrol;
        }
